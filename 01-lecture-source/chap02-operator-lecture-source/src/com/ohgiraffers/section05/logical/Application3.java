...
public class Application3 {
    public static void main(String[] args) {
        ...
        * 논리식 || 논리식 : 앞의 결과가 true 이면 뒤를 실행 안함
        ...
        /* 1. 논리식 && 논리식 : 앞의 결과가 false 이면 뒤를 실행 안함 */
        /*
        * 조건식 두 개가 모두 만족되어야 true를 변환하지만 앞에 미리 false가 나오게 되면
        ...
        * 따라서 연산 횟수를 줄이기 위해서는 && 연산의 경우 앞에 false가 나올 가능성이 높은 조건을 작성하는 것이 좋다
        ...
        int result = (false && ++num1 > 0) ? num1 : num1;   // (조건식) ? true일때 : false일때 ;

        System.out.println("&&실행 확인 : " + result);

        /* 2. 논리식 || 논리식 : 앞의 결과가 true 이면 뒤를 실행 안함 */
        /* 조건식 중 둘 중 하나라도 true를 반환하면 true를 반환하기 때문에 앞에서 미리 true를
