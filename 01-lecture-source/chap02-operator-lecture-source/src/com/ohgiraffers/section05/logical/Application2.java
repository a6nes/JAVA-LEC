...
public class Application2 {
    public static void main(String[] args) {
        ...
        * 논리 and 연산자 우선순위가 논리 or 우선순위보다 높다
        ...
        char ch2 = 'y';
        System.out.println(" 대소문자와 상관없이 영문자 y인지 확인 : " + (ch2 == 'y' || ch2 == 'Y'));

        char ch3 = 'Y';
        System.out.println(" 대소문자와 상관없이 영문자 y인지 확인 : " + (ch3 == 'y' || ch3 == 'Y'));

        char ch4 = 'a';
        System.out.println(" 대소문자와 상관없이 영문자 y인지 확인 : " + (ch4 == 'y' || ch4 == 'Y'));

        /* 4. 영문자인지 확인 */
        /* A : 65, Z : 90, a : 97, z : 122 (중간의 91~96 까지는 영문자가 아님)
         */

        char ch5 = 'f';
        System.out.println("영문자인지 확인 : " + ((ch5 >= 'A' && ch5 <= 'Z') || (ch5 >= 'a' && ch5 <= 'z')));
        System.out.println("영문자인지 확인 : " + ((ch5 >= 65 && ch5 <= 90) || (ch5 >= 97 && ch5 <= 122))); // 아스키코드 사용
