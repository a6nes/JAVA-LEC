...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * 연산자 중 참 혹은 거짓을 반환하는 연산자는 삼항연산자의 조건식이니 조건문의 조건절에 많이 사용된다
        * (충분히 연습이 필요함 !)
        *
         */
        ...
        *
        ...
        double dnum1 = 10.0;        // 실수의 대표 자료형 double
        double dnum2 = 20.0;
        ...
        System.out.println("dnum1이 dnum2과 같거나 큰지 비교 " + (dnum1 >= dnum2));
        System.out.println("dnum1이 dnum2보다 작은지 비교 " + (dnum1 < dnum2));
        System.out.println("dnum1이 dnum2과 같거나 작을때 " + (dnum1 <= dnum2));
        ...
        System.out.println("ch1이 ch2와 같거나 큰지 비교 " + (ch1 >= ch2));
        System.out.println("ch1이 ch2보다 작은지 비교 " + (ch1 < ch2));
        System.out.println("ch1이 ch2와 같거나 작은지 비교 " + (ch1 <= ch2));
