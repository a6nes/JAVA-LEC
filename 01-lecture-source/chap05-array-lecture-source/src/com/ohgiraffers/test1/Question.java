...
public class Question {
    ...
    /* test1 패키지
    * 1. 기본 자료형 8가지를 선언 및 초기화 해주세요(0 제외 아무값)
    * 2. 정수 int의 값을 long 타입과 합하여 주세요
    * 3. 삼항연산자를 이용하여 2.의 합계를 0보다 클 때 양수입니다 0보다 작을때
    *   음수입니다 를 표기해주세요
    *
    * TestMethod를 만들고
    ...
    * 반지름 값을 입력받아 실수형태로 값을 변수로 받아 리턴 받는 CircleArea 메소드를 만들어주세요
    *
    ...
    * test2 패키지
    * Application을 만들고
    * 1. TestMethoddml Calculator를 전달인자로 2,5를 주어 값을 출력해주세요
    * 2. TestMethod의 CircleAreaf를 원의 부피는 **입니다를 출력하는 구문을 만들어주세요
