...
public class Application2 {
    public static void main(String[] args) {
        ...
        * 발생한 주소를 래퍼런스 변수(참조형 변수)에 저장하고 이것을 참조하고 사용하기 때문에 참조자료형이라고 한다.
         */
        /*
        * 배열을 할당시에는 반드시 배열의 크기를 지정해주어야 한다.
         */
        ...
        * stack(주소는 stack에 저장)에 저장된 주소로 heap에 할당된 배열을 찾아갈 수 있다.
         */
        ...
        * 동일객체인지 비교할 때 사용할 목적으로 쓰이며 동등 객체를 동일 객체 취급하기 위해 오버라이딩해서 사용한다.
        ...
        System.out.println("darr의 hashcode : " + darr.hashCode()); // 186370029
        System.out.println("darr의 길이 : " + darr.length);

        darr = new double[30];
        System.out.println("변경 후 darr의 hashcode : " + darr.hashCode()); // 186370029
