...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        *   2-1. 자동형변환이 적용되지 않는 경우
        ...
        int num1 = 10;
        long num2 = 20; // int 보다 큰 수를 대입해줄때는 20 -> 20L 로 써준다. 그렇지 않으면 컴파일러가 int로 인식하고 에러발생.

        // int result = num1 + num2;   // 자동으로 큰 자료형인 long타입으로 변경 후에 계산하기 때문에 int형 변수에 값을 담을 수 없다.
        long result1 = num1 + num2; // int + long은 다른 자료형이라 데이터 손실이 발생하지 않는 int -> long 변환을 자동으로 수행한 후 연산한다.
