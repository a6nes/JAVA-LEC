...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 1-2. 실수와 실수의 연산 */
        /* 실수끼리의 연산도 수학에서 사용하는 사직연산에 나머지를 구하는 연산을 사용할 수 있다. */
        ...
        /* 정수와 실수의 연산 */
        /* 정수와 실수의 연산도 수학에서 사용하는 사적 연산에 나머지를 구하는 연산을 사용할 수 있다. */
        System.out.println("========정수 실수의 연산=========="); // 항상 실수만 나온다
        System.out.println(123 + 1.0);
        System.out.println(123 - 1.0);
        System.out.println(123 * 10.0);
        System.out.println(120 / 0.7);
        System.out.println(120 % 0.7); // 약간의 오차가 생깁니다
...
//      System.out.println("hello"%"world"); // 에러발생
        ...
        /* 문자열과 연산은 '+' 연산만 가능하다 */ // 연산 결과는 다른형태의 값들도 문자열로 취급하여 문자열 이어붙이기(문자열 합치기) 결과가 나오게 된다 */
...
/*      System.out.println(true + 0.1);
        ...
        System.out.println(true % 0.111);*/ // 에러발생

        /* 4-4 논리값과 문자의 연산 */
        /* 논리값과 문자의 연산 모든 연산자 사용이 불가능하다 */ /* 이유는 문자는 내부적으로 숫자취급을 하기 때문에 결국 논리값과 숫자의 연산과 동일하다 */
/*        System.out.println(true + 'a');
        ...
        System.out.println(true + "a"); // 문자열 합치기가됨
/*        System.out.println(true - "a");
        System.out.println(true * "a");
        System.out.println(true / "a");
        System.out.println(true % "a");*/
