...
public class Application1 {
    public static void main(String[] args) {
        ...
        System.out.println("substring(3, 6) : " + javaoracle.substring(3, 6)); // aor, 3번째 인덱스값부터 5번 인덱스까지
        System.out.println("substring(3) : " + javaoracle.substring(3));

        System.out.println("toLowerCase() : " + caseStr.toLowerCase()); // 원본 영향 x
        ...
        /* isEmpty() : 문자열의 길이가 0이면 true를 반환하고, 0이 아니면 false를 반환한다. */
