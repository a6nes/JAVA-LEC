...
public class Application {
    public static void main(String[] args) {
        ...
        * 추상클래스는 클래스 선언부 abstract 키워드를 명시해야 한다.
        * 추상클래스로는 인스턴스 생성이 불가능하다.
        * 추상클래스를 사용하려면 추상클래스를 상속 받는 하위클래스를 이용하여 인스턴스를 생성해야 한다.
        * 이때 추상클래스는 상위 타입으로 사용될 수 있으며 다형성을 이용할 수 있다.
         */

        /*
        * 추상클래스에 작성된 주상메소드는 반드시 후손이 오버라이딩해서 작성해야하며
...
//        Product product = new Product(); // 추상클래스는 인스턴스 생성불가
        ...
        * 필수 기능을 정의하여 강제성을 부여해 개발 시 일관된 인터페이스를 제공할 수 있다.
        ...
        /*
        * 하지만, 다른 클래스를 상속 받고 있는 클래스를 작성할시에는 추상클래스를 추가로 상속받을 수 없다.
