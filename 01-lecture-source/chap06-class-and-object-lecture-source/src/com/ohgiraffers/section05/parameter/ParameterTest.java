...
public class ParameterTest {
    ...
    public void testVariableLengthArray(String name, String ...hobby) { // ... 은 표기법(가변인자)
    ...
    /*public void testVariableLengthArray(String ...hobby) { // ... 은 표기법(가변인자)
        ...
        System.out.println();
    }*/                                 // 파라미터가 가변 배열 하나인 경우는 오버로딩을 하지 않는게 좋다.(모호성)
}
