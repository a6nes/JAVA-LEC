...
public class Application {
    public static void main(String[] args) {
        ...
        * 특히 메소드 재정의(overridng)라는 기술을 이용해서 부모가 가진 메소드를 재정의하는 것도 가능하다.
         */
        ...
        *   1-1. 재사용시 생산성을 크게 항상시킬 수 있다. (새롭게 작성하는 것보다 빠르다.)
        ...
        * 3. 부모클래스에서는 의미있었던 기능들이 자식 클래스에서는 무의미할 수 있다.(불필요한 기능이 추가됨)
        ...
        /*
        * 장점과 단점을 고려했을 때 상속은 재사용이라는 장점만을 바라보게 되면 오용의 기능성이 있기 때문에 유지보수에
        ...
        * 객체지향 프로그램이라고 한다.
        ...
        /*
        * 적절한 책임을 수행하는 객체 또한 그 객체만 수행할 수 있는 기능이라기 보다 역할의 관점으로 봐라바야한다.
